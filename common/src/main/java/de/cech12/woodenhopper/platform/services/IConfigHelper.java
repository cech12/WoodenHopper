...
public interface IConfigHelper {
    ...
    String PULL_ITEMS_FROM_WORLD_ENABLED_DESCRIPTION = "Whether or not the wooden hopper can pull item entities lying above it. (default: " + PULL_ITEMS_FROM_WORLD_ENABLED_DEFAULT + ")";
    ...
    String PULL_ITEMS_FROM_INVENTORIES_ENABLED_DESCRIPTION = "Whether or not the wooden hopper can pull items from inventories above it. (default: " + PULL_ITEMS_FROM_INVENTORIES_ENABLED_DEFAULT + ")";
